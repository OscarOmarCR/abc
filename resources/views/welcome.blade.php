            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading">
                        <h6>Our Services</h6>
                        <h4>Tecnologias <em>de Desarrollo</em></h4>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="owl-service-item owl-carousel">
                        <div class="item">
                            <div class="service-item">
                                ...
                                <h4>Php</h4>
                                <p>El lenguaje PHP, es un lenguaje de programación que permite el desarrollo web o aplicaciones web dinámicas.
                                </p>
                            </div>
                        </div>
                        <div class="item">
                            <div class="service-item">
                                <div class="icon">
                                    <img src="assets/images/service-icon-033.png" alt="">
                                </div>
                                <h4>Tailwind CSS</h4>
                                <p>Tailwind CSS es un framework CSS que permite un desarrollo ágil, basado en clases de utilidad que se pueden aplicar con facilidad.
                                </p>
                            </div>
                        </div>
                        <div class="item">
                            <div class="service-item">
                                <div class="icon">
                                    <img src="assets/images/service-icon-011.png" alt="">
                                </div>
                                <h4>My Sql</h4>
                                <p>Sistema de gestión de bases de datos relacional desarrollado bajo licencia dual: Licencia pública general/Licencia comercial por Oracle Corporation.
                                </p>
                            </div>
                        </div>
                        <div class="item">
                            <div class="service-item">
                                ...
                                <h4>Laravel 8/9</h4>
                                <p>Framework de código abierto para desarrollar aplicaciones y servicios web con PHP 5, PHP 7 y PHP 8.
                                </p>
                            </div>
                        </div>
                        <div class="item">
                            <div class="service-item">
                                ...
                                <h4>WordPress</h4>
                                <p> Sistema de gestión de contenidos (CMS) de código abierto. Es la fuente del software en el que se basa WordPress.com.</p>
                            </div>
                        </div>
                        <div class="item">
                            <div class="service-item">
                                ...
                                <h4>Bootstrap 4/5</h4>
                                <p>Biblioteca multiplataforma o conjunto de herramientas de código abierto para diseño de sitios y aplicaciones web.</p>
                            </div>
                        </div>
                        <div class="item">
                            <div class="service-item">
                                <div class="icon">
                                    <img src="assets/images/st,small,507x507-pad,600x600,f8f8f8.png" alt="">
                                </div>
                                <h4>Laravel Jetstream</h4>
                                <p>Plataforma perfecta de scaffolding que se encuentra basado en framework PHP. Esto le permite ofrecer una gran cantidad de opciones para crear aplicaciones con Laravel.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 align-self-center">
                    ...
                    <div class="white-button">
                        <a href="{{route('contactUs')}}">View Courses</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <p class="copyright">Copyright © 2022 EduWell Co., Ltd. All Rights Reserved.
                        ...
                        <br>Distribution: <a rel="sponsored" href="https://themewagon.com"
